...
# Account Information
to = 'swicano+rpi2@gmail.com' # Email to send to.
gmail_user = 'swicano@gmail.com' # Email to send from. (MUST BE GMAIL)
gmail_password = 'WOMP WOMP I SHOULDNT HAVE DONE THAT' # Gmail password.
...
arg2 = 'curl http://ipecho.net/plain; echo'
p2 = subprocess.Popen(arg2,shell=True,stdout=subprocess.PIPE)
...
msg['Subject'] = 'IP is %s For RaspberryPi2 at Home on %s' % (data2[0],today.strftime('%b %d %Y'))
msg['From'] = gmail_user
msg['To'] = to
# Sends the message
